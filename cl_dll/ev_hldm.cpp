...
//	  REVOLVER START
//======================
// Shared Revolver fire implementation for EV_FireRevolver1 and EV_FireRevolver2.
static void EV_FireRevolver_Impl( event_args_t *args )
{
	int idx;
	vec3_t origin;
	vec3_t angles;
...
void EV_FireRifle( event_args_t *args )
{
	...
	EV_HLDM_FireBullets( idx, forward, right, up, 1, vecSrc, vecAiming, 8192, BULLET_PLAYER_RIFLE, 0, 0, args->fparam1, args->fparam2 );
}
//======================
//	    RIFLE END 
//======================
