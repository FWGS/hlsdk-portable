...
typedef enum 
{
		...
		SCHED_AISCRIPT,
		SCHED_FAIL,
		SCHED_CHASE_DEAD_ALLY,
		SCHED_RELOAD_DEEP,
		SCHED_DISARM_WEAPON,
		SCHED_IDLE_WALK_PATH,
		SCHED_IDLE_WALK_AROUND,
		SCHED_LONGMING,
		SCHED_FAKEDIE,
...
typedef enum 
{
		...
		TASK_FACE_ALLY,
		TASK_GET_PATH_TO_ALLY_CORPSE,
		TASK_GET_PATH_TO_RETURN_OLD_ORIGIN,
		TASK_FIND_COVER_FROM_ENEMY_RELOAD,
		TASK_FIND_ROAD_FORWARD,
		TASK_COVER_RUN_PATH,
		TASK_SET_LONGMING,
		TASK_FOGET_ENEMY,
		TASK_FAKEDIE,
...
#define bits_COND_NEW_COVER_MODE		( 1 << 14)
