...
#define EMIT_ARCH_SOUND( chan, array ) \
	EMIT_SOUND_DYN ( ENT(pev), chan , array [ RANDOM_LONG(0,ARRAYSIZE( array )-1) ], 1.0, 0.6, 0, RANDOM_LONG(95,105) ); //see here Alex
...
Schedule_t slTwitchDieArcher[] =
{
	{
		tlTwitchDieArcher,
		ARRAYSIZE( tlTwitchDieArcher ),
		0,
		0,
		"Die"
	},
...
float CArcher::FlPitchDiff( void )
{
	float	flPitchDiff;
