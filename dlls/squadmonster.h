...
// ROBOTIC INFANTRY SLOTS
#define bits_SLOT_R_INFANTRY_ENGAGE1	( 1 << 0 )
#define bits_SLOT_R_INFANTRY_ENGAGE2	( 1 << 1 )
#define bits_SLOTS_R_INFANTRY_ENGAGE	( bits_SLOT_HGRUNT_ENGAGE1 | bits_SLOT_HGRUNT_ENGAGE2 )

#define bits_SLOT_R_INFANTRY_GRENADE1	( 1 << 2 ) 
#define bits_SLOT_R_INFANTRY_GRENADE2	( 1 << 3 ) 
#define bits_SLOTS_R_INFANTRY_GRENADE	( bits_SLOT_HGRUNT_GRENADE1 | bits_SLOT_HGRUNT_GRENADE2 )
