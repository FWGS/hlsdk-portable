...
class CZombie_Barney : public CBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_zombie_barney, CZombie_Barney );

const char *CZombie_Barney::pAttackHitSounds[] = 
{
...
const char *CZombie_Barney::pAttackMissSounds[] = 
{
	"zombie/claw_miss1.wav",
	"zombie/claw_miss2.wav",
};

const char *CZombie_Barney::pAttackSounds[] = 
{
	"zombie/zo_attack1.wav",
	"zombie/zo_attack2.wav",
};

const char *CZombie_Barney::pIdleSounds[] = 
{
	"zombie/zo_idle1.wav",
	"zombie/zo_idle2.wav",
	"zombie/zo_idle3.wav",
...
const char *CZombie_Barney::pAlertSounds[] = 
{
...
const char *CZombie_Barney::pPainSounds[] = 
{
	"zombie/zo_pain1.wav",
	"zombie/zo_pain2.wav",
};
...
// relationship table.
//=========================================================
int	CZombie_Barney :: Classify ( void )
{
	return	CLASS_ALIEN_MONSTER;
}

void CZombie_Barney :: RunAI( void )
{
	CBaseMonster :: RunAI();
	/*
...
BOOL CZombie_Barney :: CheckMeleeAttack1 ( float flDot, float flDist )
{
	float dist = 64;
	if(pev->impulse == 1){
			TraceResult tr;
...
//=========================================================
void CZombie_Barney :: SetYawSpeed ( void )
{
	pev->yaw_speed = 120;
}

void CZombie_Barney::TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int bitsDamageType)
{
	if(ptr->iHitgroup == 1)
	{
...
int CZombie_Barney :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
	return CBaseMonster::TakeDamage( pevInflictor, pevAttacker, flDamage, bitsDamageType );
}

void CZombie_Barney::Killed( entvars_t *pevAttacker, int iGib )
{
...
void CZombie_Barney :: PainSound( void )
{
...
void CZombie_Barney :: AlertSound( void )
{
	int pitch = 95 + RANDOM_LONG(0,9);
...
void CZombie_Barney :: IdleSound( void )
{
	int pitch = 95 + RANDOM_LONG(0,9);
...
void CZombie_Barney :: AttackSound( void )
{
...
//=========================================================
void CZombie_Barney :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	int dmg1,dmg2;
	dmg1 = 20;
	dmg2 = 40;
...
int CZombie_Barney::IgnoreConditions ( void )
{
