...
#define		LEECH_ACCELERATE		15
#define		LEECH_CHECK_DIST		60
#define		LEECH_SWIM_SPEED		60
#define		LEECH_SWIM_ACCEL		90
...
//	UTIL_SetSize( pev, g_vecZero, g_vecZero );
	UTIL_SetSize( pev, Vector(-5,-5,-3), Vector(5,5,3));
	...
	case LEECH_AE_ATTACK:
		...
		if ( pEnemy != NULL )
		{
			...
			if ( DotProduct(dir, face) > 0.9 )		// Only take damage if the leech is facing the prey
				pEnemy->TakeDamage( pev, pev, 5, DMG_SLASH );
		}
		m_stateTime -= 2;
		break;
