...
//=========================================================
void CMariozombie::SetYawSpeed( void )
{
	int ys;
...
int CMariozombie::TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
...
void CMariozombie::PainSound( void )
{
...
int CMariozombie::IgnoreConditions( void )
{
