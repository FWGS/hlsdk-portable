...
void CMP5::SecondaryAttack( void )
{
	...
	m_pPlayer->m_flStopExtraSoundTime = UTIL_WeaponTimeBase() + 0.1f;
	...
	CGrenade::ShootContact( m_pPlayer->pev,
					m_pPlayer->pev->origin + m_pPlayer->pev->view_ofs + gpGlobals->v_forward * 60.0f, 
					gpGlobals->v_forward * 2001.0f );
	...
	m_flTimeWeaponIdle = UTIL_WeaponTimeBase() + 0.05f;// idle pretty soon after shooting.
