...
// started moving.
//=========================================================
void CNGrunt::SpeakSentence( void )
{
...
//=========================================================
int CNGrunt::IRelationship( CBaseEntity *pTarget )
{
	return CSquadMonster::IRelationship( pTarget );
}

void CNGrunt::IdleSound( void )
{
	if( FOkToSpeak() && ( g_fGruntQuestion || RANDOM_LONG( 0, 1 ) ) )
	{
		if( !g_fGruntQuestion )
		{
			...
			case 0:
				// check in
				//SENTENCEG_PlayRndSz( ENT( pev ), "NG_IDLE", HGRUNT_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch );
				g_fGruntQuestion = 1;
				break;
			case 1:
				// question
...
//=========================================================
void CNGrunt::HandleAnimEvent( MonsterEvent_t *pEvent )
{
	Vector vecShootDir;
...
void CNGrunt::Spawn()
{
	...
	SET_MODEL( ENT( pev ), "models/ngrunt.mdl" );
	...
	if( FBitSet( pev->weapons, HGRUNT_SHOTGUN ) )
	{
		SetBodygroup( HEAD_COMMANDER, GUN_SHOTGUN );
		m_cClipSize = 8;
	}
	else
	{
...
//=========================================================
void CNGrunt::Precache()
{
	PRECACHE_MODEL( "models/ngrunt.mdl" );

	PRECACHE_SOUND( "hgrunt/gr_mgun1.wav" );
	PRECACHE_SOUND( "hgrunt/gr_mgun2.wav" );

	PRECACHE_SOUND( "ngrunt/ngr_death1.wav" );
	PRECACHE_SOUND( "ngrunt/ngr_death2.wav" );
	PRECACHE_SOUND( "ngrunt/ngr_death3.wav" );
...
// DeathSound 
//=========================================================
void CNGrunt::DeathSound( void )
{
	switch( RANDOM_LONG( 0, 2 ) )
	{
	case 0:
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "ngrunt/ngr_death1.wav", 1, ATTN_IDLE );
		break;
	case 1:
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "ngrunt/ngr_death2.wav", 1, ATTN_IDLE );
		break;
	case 2:
		EMIT_SOUND( ENT( pev ), CHAN_VOICE, "ngrunt/ngr_death3.wav", 1, ATTN_IDLE );
		break;
	}
}
...
// Get Schedule!
//=========================================================
Schedule_t *CNGrunt::GetSchedule( void )
{
...
//=========================================================
//=========================================================
Schedule_t *CNGrunt::GetScheduleOfType( int Type ) 
{
	switch( Type )
	{
...
void CNGruntRepel::Spawn( void )
{
	Precache();
	pev->solid = SOLID_NOT;

	SetUse( &CNGruntRepel::RepelUse );
}

void CNGruntRepel::Precache( void )
{
	UTIL_PrecacheOther( "monster_nari_grunt" );

	m_iSpriteTexture = PRECACHE_MODEL( "sprites/rope.spr" );
}

void CNGruntRepel::RepelUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	TraceResult tr;
	...
	*/
	...
	CBaseEntity *pEntity = Create( "monster_nari_grunt", pev->origin, pev->angles );
