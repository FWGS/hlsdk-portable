...
//=========================================================
// IRelationship - overridden because Human Grunt are
// Black Ops's nemesis.
//=========================================================
int CBlkopApache::IRelationship( CBaseEntity *pTarget )
{
	if( FClassnameIs( pTarget->pev,  "monster_apache" ) || FClassnameIs( pTarget->pev,  "monster_human_grunt" ) )
	{
		return R_NM;
	}
