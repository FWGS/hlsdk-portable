...
public:
	...
	CBaseEntity *FindTeamSpawnPoint();
	void Timer_AutokickThink();
	void Timer_CeaseFireThink();
	void Timer_SpyUndercoverThink();
	void Timer_FinishedBuilding();
	void Timer_CheckBuildDistance();
	void Timer_DetpackDisarm();
	void Timer_DetpackSet();
	void Timer_Birthday();
	void Timer_Regeneration();
	void Timer_Tranquilisation();
	void Timer_Hallucination();
	void Timer_HealthRot();
	...
	// TODO: Need to sort fields for binary compatibility
	// part 1
	int tfstate;
	int goal_no;
	int group_no;
